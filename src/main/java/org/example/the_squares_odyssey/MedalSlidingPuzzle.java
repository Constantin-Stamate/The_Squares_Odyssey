...
public class MedalSlidingPuzzle extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        Image backgroundImage = new Image(getClass().getResource("/static/images/medals/medalie_14.png").toExternalForm());
        ...
        String path = Paths.get("src/main/resources/templates/pride_1.html").toUri().toString();
